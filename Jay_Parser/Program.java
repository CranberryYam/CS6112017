...
public class Program {
	...
	public String display() {
		...
		String dec = decpart==null ? (new Indenter(level+1)).display("Declarations: empty") : decpart.display(level + 1);
		String bod = body==null ? (new Indenter(level+1)).display("Block: empty") : body.display(level + 1);
		String nl = "\n";
		return s + dec + bod + nl;
	}
}
